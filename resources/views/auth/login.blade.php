    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html">
                            @if($ajuste)
                            <img src="{{ asset('storage/' . $ajuste->logo) }}" style="width: 180px; height: 130px;" alt="Logo">
                            @else
                    ...
                    <p class="auth-subtitle mb-5">Inicio de Sesión</p>
            ...
            <div class="col-lg-7 d-none d-lg-block">
             <div id="auth-right" style="background-image: url('{{ asset($imagen_login) }}'); background-size: cover; background-position: center;">
            </div>
            </div>
        </div>
