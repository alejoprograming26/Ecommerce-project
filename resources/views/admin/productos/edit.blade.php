...
@section('content')
    <h2>
        Editar Producto : {{ $producto->nombre }}</h2>
    <hr>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="codigo" id="codigo"
                                            placeholder="PROD0000" value="{{ old('codigo', $producto->codigo) }}" required>
                                    </div>
                                    @error('codigo')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                                ...
                                                <div class="input-group">
                                                    <div style="width: 100%">
                                                        <textarea class="form-control ckeditor" name="descripcion_larga" id="descripcion_larga" rows="6"
                                                            placeholder="">{{ old('descripcion_larga', $producto->descripcion_larga) }}</textarea>
                                                    </div>
                                                </div>
