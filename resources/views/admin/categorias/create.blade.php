...
@section('content')
    <h2>
        Crear Categoria del Sistema</h2>
    <hr>
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="nombre" id="nombre"
                                            placeholder="Ingrese el Nombre de la Categoria" value="{{ old('nombre') }}" required>
                                    </div>
                                    @error('nombre')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="slug" id="slug"
                                            placeholder="Ingrese el Slug" value="{{ old('slug') }}" readonly required>
                                    </div>
                                    @error('slug')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <textarea name="descripcion" id="descripcion" class="form-control" cols="30" rows="4" placeholder="Ingrese la Descripción">{{ old('descripcion') }}</textarea>
                                    </div>
                                    @error('descripcion')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
